...
begin
  ...
  s:=StringReplace(s, 'XXXX in','modding',[rfReplaceAll]);
  s:=StringReplace(s, 'XXXX','modding',[rfReplaceAll]);
  s:=StringReplace(s, 'XXXX','runtimemodifier',[rfReplaceAll]);
  s:=StringReplace(s, 'runtimemodifier.org','XXXX.org',[rfReplaceAll]);
  s:=StringReplace(s, 'XXXX','modification',[rfReplaceAll]);
  s:=StringReplace(s, 'Tutorial-','rtm-Tutorial-',[rfReplaceAll, rfIgnoreCase]);
  s:=StringReplace(s, 'XXXX Table','Code Table',[rfReplaceAll]);
  s:=StringReplace(s, 'XXXX','Codetable',[rfReplaceAll]);
