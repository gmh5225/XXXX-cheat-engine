...
initialization
  ...
  begin
    ...
    if r.OpenKey('\Software\'+{$ifdef altname}'Runtime Modifier'{$else}'XXXX engine'{$endif},false) then
    begin
    ...
    begin
      ...
      if r.OpenKey('\Software\'+{$ifdef altname}'Runtime Modifier'{$else}'XXXX engine'{$endif},true) then
      begin
        //I do have access
