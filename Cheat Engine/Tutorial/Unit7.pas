...
resourcestring
  ...
  rsTutorialStep6=
    ...
    'Go back to the main XXXX engine window (you can keep this extra info window open if you want, but if you close it, '+
    ...
    'smallest one. Now click on the "Add Addr4ss Manually" button and select the pointer checkbox.'+#13#10+
    ''+#13#10+
